...
//                "The clothes should be ready by Wednesday", LocalDate.of(2016, Month.APRIL, 20));
...
//        TodoData.getInstance().setTodoItems(todoItems);
        ...
        todoListView.getSelectionModel().selectedItemProperty().addListener(new ChangeListener<TodoItem>() {
            @Override
            public void changed(ObservableValue<? extends TodoItem> observableValue, TodoItem todoItem,
                                TodoItem t1) {
                if (t1 != null) {
